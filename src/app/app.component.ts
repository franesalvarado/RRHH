...
export class AppComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    // Opciones del Sidenav dependiendo del tipo de usuario logueado DIRECTOR
    ...
    // Opciones del Sidenav dependiendo del tipo de usuario logueado ADMINGLOBAL      
      if (this.tipoUsuario === 'AdminGlobal') {
        ...
        // Opciones del Sidenav dependiendo del tipo de usuario logueado ADMIN      
        if (this.tipoUsuario === 'Admin') {
          ...
          // Opciones del Sidenav dependiendo del tipo de usuario logueado PERSONAL DE RRHH      
